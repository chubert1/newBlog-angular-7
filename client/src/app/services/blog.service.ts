...
export class BlogService {
  ...
  likeBlog(id) {
    ...
    return this.http.put(this.domain + 'blogs/likeBlog/', blogData, this.options).pipe(map(res => res));
  }

  // Function to dislike a blog post
  dislikeBlog(id) {
    const blogData = { id: id };
    return this.http.put(this.domain + 'blogs/dislikeBlog/', blogData, this.options).pipe(map(res => res));
  }
  ...
  postComment(id, comment) {
    ...
    return this.http.post(this.domain + 'blogs/comment', blogData, this.options).pipe(map(res => res));
